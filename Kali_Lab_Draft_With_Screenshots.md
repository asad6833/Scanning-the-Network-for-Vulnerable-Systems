# Kali Linux Lab — Draft Documentation (Work in Progress)

> **Note:** This is a draft file combining the written lab instructions you shared _plus_ the two screenshots.  
> You can rename this file to `README.md` in your GitHub repo when you're ready.
...
This draft will keep growing as more lab steps and screenshots are added.  
When you are ready, you can rename this file to `README.md` and push it to your GitHub repo.
